...
The Commerce example templates avoid displaying a “Register me for a user account” checkbox if a user account already exists for the email address on the current cart:
