...
4. The order reference number is generated for the order, based on the ‘Order Reference Number Format‘ setting found in Commerce → Settings → System Settings → General Settings section of the control panel.
