...
Pint is a _static analysis_ tool, and runs independently from Laravel or Craft; this means it can provide feedback via the command line or in CI without booting the application.
