...
updatedVersion: 5.x/reference/element-types/entries.md
---
...
- Choose the entry’s **Author** <Badge type="edition" vertical="middle" title="Entries can only have authors in Craft Pro">Pro</Badge>;
