...
You can fetch your site’s tax categories through the [TaxCategories](commerce3:craft\commerce\services\TaxCategories) service:
...
You can fetch all of your site’s tax rates through the [TaxRates](commerce3:craft\commerce\services\TaxRates) service:
...
The zip code formula is an expression written in [Twig’s expression syntax](https://twig.symfony.com/doc/3.x/templates.html#expressions) that returns `true` or `false`.
...
You can fetch your site’s tax zones through the [TaxZones](commerce3:craft\commerce\services\TaxZones) service:
