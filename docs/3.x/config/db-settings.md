...
if you wanted to enable a SSL database connection—assuming [SSL is enabled in MySQL](https://dev.mysql.com/doc/refman/5.7/en/using-encrypted-connections.html) and `'user'`
