---
description: Craft requires PHP 8.5 and a MySQL or Postgres database.
---
...
::: tip
We recommend [ImageMagick](http://php.net/manual/en/book.imagick.php) over GD for expanded [image handling options](/5.x/development/image-transforms.md).
...
Additionally, during [setup](kb:first-time-setup) or when [updating](/5.x/update.md) or installing [plugins](/5.x/system/plugins.md) via the [control panel](/5.x/system/control-panel.md) or [CLI](/5.x/system/cli.md), Craft may touch these files:
