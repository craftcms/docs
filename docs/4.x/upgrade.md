...
6. Edit your project’s `composer.json` to require `"craftcms/cms": "^4.0.0"` and Craft-4-compatible plugins all at once. (You may also need to update your platform requirement to `php: "8.0.2"`.)
