...
Commerce Lite is for websites that need only the basics, where one-off product sales, subscriptions, complex tax and shipping rules, promotion management, and shopping carts would be overkill.
