...
(You may also need to update your platform requirement to `php: "8.0.2"`.)
    ::: tip
    You’ll need to manually edit each plugin version in `composer.json`, and you may need to change your [`minimum-stability`](https://getcomposer.org/doc/04-schema.md#minimum-stability) if you’re including beta versions of plugins.
    :::
