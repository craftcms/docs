...
At a high level, Craft is one of many service providers that Laravel can discover.
...
Since Craft 3.x, many developers have used *modules* to add functionality to individual projects or share it semi-privately between many.
