...
In addition to organization, Site Groups can help control a Section's Propagation Method. By selecting "Save entries to other sites in the same group", Craft will only propagate new Entries to sites in the same group.  
