...
::: tip
デフォルトでは、名前があまりにも似ている複数のタグを作成できません。 コンフィグ設定の <config3:allowSimilarTags> コンフィグ設定
:::
...
| `[':empty:', 100, 200]`                                    | ID が 100 と 200 のタグが関連付けられている。                  |
| `['and', 100, 200]`                                        | タグに関連付けられている。                                  |
...
[Tag](craft3:craft\elements\Tag) オブジェクト
