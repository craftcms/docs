...
::: tip
You can test these pages even if [Dev Mode](config4:devMode) is enabled by going to `https://my-project.tld/404`, substituting `404` for the name of the template you’re testing.
:::
